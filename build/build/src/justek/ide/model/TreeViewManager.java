...
public class TreeViewManager {
	...
	public ObservableList<TreeItem<String>> getNodeInfo() {
		...
		ObservableList<TreeItem<String>> nodes = FXCollections.observableArrayList();
			...
			TreeItem<String> nodeB2 = new TreeItem<>("Motor Limits");
			...
			nodes.add(nodeC);
			TreeItem<String> nodeC1 = new TreeItem<>("Setting Window");
...
//			nodeD.getChildren().add(nodeD2);
			...
			nodes.add(nodeE);
//			TreeItem<String> nodeE1 = new TreeItem<>("Identification");
	  ...
	  public void mouseClick(MouseEvent mouseEvent) {
	    	...
	    	if(mouseEvent.getClickCount()==1) {
	    		if(item==null) {
	    			...
	    			if(item.getValue().equals("Setting Window")) {
	    				mainApp.AxisSetup7();
	    			} 
