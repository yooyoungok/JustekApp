...
public class DefaultTriggerData {
	...
	public XYDataset createDataset2() {
		...
		System.out.print("TriggerData createDataSet2 MinY = "+series2.getMinY());
		XYSeriesCollection collection = new XYSeriesCollection();
	...
	public void getLeftChart() {
		try {
			BufferedReader uc = new BufferedReader(new FileReader("./home/trigger/"+this.LeftChartName+".txt"));
	...
	public void getRightChart() {
		try {
			BufferedReader uc = new BufferedReader(new FileReader("./home/trigger/"+this.RightChartName+".txt"));
	...
	public void getLeftChart(String chartName) {
		...
		try {
			BufferedReader uc = new BufferedReader(new FileReader("./home/trigger/"+chartName+".txt"));
